...
//load the texture image to the scene
...
void draw_right_arm(void)
{
   ...
   glRotatef(-(GLfloat)shoulder2, 0.0, 1.0, 0.0); //rotate up
   glTranslatef(1.0, 0.0, -0.5);
   glRotatef(-(GLfloat)shoulder3, 1.0, 0.0, 0.0); //rotate around itself
...
int main (int argc, char** argv)
{
   ...
   init();
	...
	glutAddMenuEntry("", 0);
	glutAddMenuEntry("wood", 's');
	glutAddMenuEntry("wood2", 'a');
